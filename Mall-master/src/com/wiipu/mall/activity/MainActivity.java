...
//		mBtnTabs.add((ImageButton) findViewById(R.id.main_btn_scan));
	...
	public void onClick(View v) {
		...
		case R.id.main_btn_home:
			...
			System.out.println("this is home"+R.id.main_btn_home);
			break;
		case R.id.main_btn_category:
			// 切换商品分类选项卡
			switchFragment(FragmentTag.TAG_CATEGORY);
			System.out.println("this is home"+R.id.main_btn_category);
			break;
...
//			break;
		case R.id.main_btn_cart:
			...
			System.out.println("this is home"+R.id.main_btn_cart);
			break;
		case R.id.main_btn_my:
			// 切换我的信息选项卡
			switchFragment(FragmentTag.TAG_MY);
			System.out.println("this is home"+R.id.main_btn_my);
			break;
		}
	}
